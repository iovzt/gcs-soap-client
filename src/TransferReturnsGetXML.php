...
class TransferReturnsGetXML
{
     ...
     * @param int $pageCount
     */
    public function __construct($userName, $password, $TransfersId, $ClientId, $CompanyId, $TransactionType, \DateTime $EffectiveDate_gte, \DateTime $EffectiveDate_lte, $Amount_Gte, $Amount_Lte, $ActiveFlag, $AdvRpmtStatus, $DRCTransactionId, $SupportingEntityName, $SupportingEntityIdValue, \DateTime $CreatedDate_Gte, \DateTime $CreatedDate_Lte, \DateTime $ModifiedDate_Gte, \DateTime $ModifiedDate_Lte, $ModifiedBy, $pageSize, $pageNumber, $rowCount, $pageCount)
    {
